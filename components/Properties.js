const Properties = [
  {
    properties: [
      {
        id: 1,
        hero: "./images/demo1_hero.jpg",
        title: "Loft moderno con amenidades premium en Santa Fe",
        ...
        gallery: [
          ...
          "./images/demo1_bathroom.jpg",
          "./images/demo1_gym.jpeg",
      ...
      },
      {
        ...
        title: "Venta de departamento funcional en zona céntrica",
      ...
      },
      {
        ...
        title: "Venta de departamento compacto ideal para inversión.",
